...
import {getRating, searchMovie, getName} from "../actions/movieActions"
    ...
    return (
        <div className="p-1 bg-light shadow-sm mb-4 nr">
            <div className="input-group">
                <input onChange={e =>{this.props.getName(e.target.value); this.props.searchByRate()} } className="form-control border-0 bg-light width" type="search" placeholder="type movie name here to search" aria-label="Search" />
